...
if(CASCODA_BUILD_KNX)
    if(NOT ((CASCODA_CHILI2_CONFIG_STRING STREQUAL "DEV_BOARD") AND (CASCODA_CHILI2_REV STREQUAL "1")))
        message(FATAL_ERROR "Not possible to enable CASCODA_BUILD_KNX, unless CASCODA_CHILI2_CONFIG_STRING is DEV_BOARD and CASCODA_CHILI2_REV is 1")
    endif()
endif()
