...
if(CASCODA_BUILD_OCF AND CASCODA_BUILD_KNX)
	message(FATAL_ERROR "Not possible to enable CASCODA_BUILD_OCF and CASCODA_BUILD_KNX simultaneously")
endif()

if(CASCODA_BUILD_KNX)
    if(NOT ((CASCODA_CHILI2_CONFIG_STRING STREQUAL "DEV_BOARD") OR (CASCODA_CHILI2_CONFIG_STRING STREQUAL "DEV_BOARD_BATT")))
        message(FATAL_ERROR "Not possible to enable CASCODA_BUILD_KNX, unless CASCODA_CHILI2_CONFIG_STRING is DEV_BOARD or DEV_BOARD_BATT")
    endif()
endif()
