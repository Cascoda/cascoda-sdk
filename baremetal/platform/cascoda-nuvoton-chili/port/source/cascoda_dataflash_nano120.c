/**
 * @file cascoda_dataflash_nano120.c
 * @brief Board Support Package (BSP) for Non-Volatile Memory Access.\n
 *        Micro: Nuvoton Nano120\n
 *        Board: All Nano120 123k Devices
...
} // End of BSP_WriteDataFlashInitial()
