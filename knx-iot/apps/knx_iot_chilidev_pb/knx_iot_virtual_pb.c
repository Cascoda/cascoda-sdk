...
char         g_serial_number[20] = "0003000";
 ...
 */
void post_InfoOnOff_1(oc_request_t *request, oc_interface_mask_t interfaces, void *user_data)
{
	(void)interfaces;
	(void)user_data;
	...
	while (rep != NULL)
	{
       ...
       hardware that sets the global variables.
     */
			do_post_cb(CH1_URL_INFOONOFF_1);
 ...
 * @param user_data the supplied user data.
 */
void post_InfoOnOff_2(oc_request_t *request, oc_interface_mask_t interfaces, void *user_data)
{
	(void)interfaces;
	(void)user_data;
	bool error_state = false;
	...
	while (rep != NULL)
	{
       ...
       hardware that sets the global variables.
     */
			do_post_cb(CH2_URL_INFOONOFF_2);
 ...
 * @param user_data the supplied user data.
 */
void post_InfoOnOff_3(oc_request_t *request, oc_interface_mask_t interfaces, void *user_data)
{
	(void)interfaces;
	(void)user_data;
	bool error_state = false;
	...
	while (rep != NULL)
	{
       ...
       hardware that sets the global variables.
     */
			do_post_cb(CH3_URL_INFOONOFF_3);
 ...
 * @param user_data the supplied user data.
 */
void post_InfoOnOff_4(oc_request_t *request, oc_interface_mask_t interfaces, void *user_data)
{
	(void)interfaces;
	(void)user_data;
	bool error_state = false;
	...
	while (rep != NULL)
	{
       ...
       hardware that sets the global variables.
     */
			do_post_cb(CH4_URL_INFOONOFF_4);
